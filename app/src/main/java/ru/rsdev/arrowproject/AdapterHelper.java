...
/**
 * Created by rsdev on 09.02.2015.
 */
public class AdapterHelper {
    ...
    String[] groups = new String[] {"Ударения", "Синонимы", "В разработке"};


    // названия телефонов (элементов)
    String[] phonesHTC = new String[] {"Offline", "Online","Словарь", "Рекорды", "Ошибки"};
    String[] phonesSams = new String[] {"Offline", "Online","Словарь", "Рекорды"};
    String[] phonesLG = new String[] {"Test1", "Test2", "Test3", "Test4", "Test5"};
    ...
    SimpleExpandableListAdapter getAdapter() {
        ...
        //Требуется переопределить вид 1й ветви дерева и внутренних
